# Derived from https://github.com/nytopop/illu/blob/master/models.py
...
class Model(
    ...
    def generate_frame(
        ...
        curr_backbone_mask = _index_causal_mask(cast(torch.Tensor, self.backbone_causal_mask), input_pos)
        ...
        for i in range(1, self.config.audio_num_codebooks):
            curr_decoder_mask = _index_causal_mask(cast(torch.Tensor, self.decoder_causal_mask), curr_pos)
